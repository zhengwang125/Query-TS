...
def run_dqn():
    ...
    while len(env_rl_sel_v.F_ward) < buffer_valid_size:
        ...
        epoch_i_c += 1
    print('test time', time.time()-start_test)
...
def Training():
    ...
    for epoch in range(12):
        ...
        tra_DB_DISTRI, _, tra_DB_DISTRI_trajID = F.get_distribution_feature_data(tra_set)
        _, query_part1, _ = F.get_query_workload_data(tra_DB_DISTRI)
        ...
        for epoch_i in range(5):
            ...
            env_rl_sam = TrajSam(tra_set, level_start, 'data')
            ...
            RL_INB.save(model_path+'save/'+globaltime+'_data_RL_INB_F1_' + str(res1)+'.h5')
            RL_OUB.save(model_path+'save/'+globaltime+'_data_RL_OUB_F1_' + str(res1)+'.h5')
...
if __name__ == "__main__":
    ...
    env_rl_sam_v = TrajSam(val_set, level_start, 'data')
    ...
    val_DB_DISTRI, _, val_DB_DISTRI_trajID = F.get_distribution_feature_data(val_set)
    _, query_part1, query_part2 = F.get_query_workload_data(val_DB_DISTRI)
